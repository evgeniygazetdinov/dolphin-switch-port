 ...
 * no longer provide the "struct mbedtls_platform_context" definition and omit the base
 * function declarations and implementations. "platform_alt.h" will be included from
 * "platform.h" to include the new function definitions.
 *
 ...
 *
 * MBEDTLS__FUNCTION_NAME__ALT: Uncomment a macro to let mbed TLS use your
 ...
 * BSD and OS X) and Windows. For other platforms, you can either disable that
 ...
 * the default value of 16KB for the incoming buffer.
 *
